...
Building rust-lib requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building rust-lib, you can explore its exports at the Node console:
